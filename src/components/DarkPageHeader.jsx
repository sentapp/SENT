 ...
 * Sticky within MissionaryPageShell scroll — same parent as page content.
 */
export default function DarkPageHeader({ title, subtitle, children, className = '' }) {
  return (
    <header
      className={`shrink-0 border-b border-[#222] bg-[#111] px-5 py-4 text-white md:px-8 ${className}`}
    >
