    ...
    <div className="space-y-6">
      ...
      <Card className="overflow-hidden border border-neutral-200/80 bg-gradient-to-b from-white to-neutral-50/80 p-6 shadow-sm">
        <div className="flex flex-col items-center text-center sm:flex-row sm:items-start sm:gap-5 sm:text-left">
          <div className="h-24 w-24 shrink-0 overflow-hidden rounded-full border-2 border-white shadow-md ring-2 ring-mission-blue/10">
            {photoUrl ? (
              <img src={photoUrl} alt="" className="h-full w-full object-cover" />
            ) : (
              <div className="flex h-full w-full items-center justify-center bg-neutral-100 text-3xl font-semibold text-neutral-400">
        ...
        <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:justify-center">
          {taxUrl ? (
            <a
              ...
              className="inline-flex flex-1 items-center justify-center rounded-btn bg-mission-blue px-5 py-3.5 text-center text-[17px] font-semibold text-white shadow-sm transition hover:opacity-95 sm:max-w-xs sm:flex-none sm:min-w-[200px]"
            >
              Give monthly
            </a>
          ) : (
          ...
          {nonTaxUrl ? (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex flex-1 items-center justify-center rounded-btn border-2 border-mission-blue bg-white px-5 py-3.5 text-center text-[17px] font-semibold text-mission-blue shadow-sm transition hover:bg-mission-blue/5 sm:max-w-xs sm:flex-none sm:min-w-[200px]"
            >
              One-time gift
            </a>
          ) : (
      ...
      {missionPush && missionPush.is_active ? (
        <Card className="border border-mission-blue/15 bg-mission-blue/[0.03] p-6 shadow-sm">
          ...
          <div className="mt-4">
            ...
            <div className="mt-2 h-3 w-full overflow-hidden rounded-full bg-neutral-200">
              <div className="h-3 rounded-full bg-mission-blue transition-all" style={{ width: `${pushPct}%` }} />
            </div>
          </div>
          {daysLeft != null ? (
