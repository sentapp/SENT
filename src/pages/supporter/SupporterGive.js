    ...
    <div className="space-y-6" style={{ '--feed-accent': feedAccent }}>
      ...
      <Card className="overflow-hidden border border-neutral-200/80 bg-gradient-to-b from-white to-neutral-50/80 p-6 shadow-sm">
        <div className="flex flex-col items-center text-center sm:flex-row sm:items-start sm:gap-5 sm:text-left">
          <div className="h-24 w-24 shrink-0 overflow-hidden rounded-full border-2 border-white shadow-md ring-2 ring-[color:color-mix(in_srgb,var(--feed-accent,var(--accent))_18%,transparent)]">
            {photoUrl ? (
        ...
        <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:justify-center">
          ...
          {nonTaxUrl ? (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex flex-1 items-center justify-center rounded-btn border-2 border-[color:var(--feed-accent,var(--accent))] bg-white px-5 py-3.5 text-center text-[17px] font-semibold text-[color:var(--feed-accent,var(--accent))] shadow-sm transition hover:bg-[color:color-mix(in_srgb,var(--feed-accent,var(--accent))_8%,white)] sm:max-w-xs sm:flex-none sm:min-w-[200px]"
            >
              One-time gift
            </a>
          ) : (
        ...
        <Card className="feed-accent-card border p-6 shadow-sm">
          ...
          <div className="mt-4">
            ...
            <div className="garden-progress-track mt-2">
              <div className="garden-progress-fill transition-all" style={{ width: `${pushPct}%` }} />
            </div>
          </div>
          {daysLeft != null ? (
